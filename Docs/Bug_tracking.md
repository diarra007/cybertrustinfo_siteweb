...
| BUG-005 | 2025-01-23 | Erreur lors de l'envoi du formulaire de contact | Résolu | P0 | - | Problème résolu : Le domaine est vérifié mais le code utilisait encore onboarding@resend.dev. Correction : utilisation de contact@cybertrustinfo.com comme expéditeur par défaut maintenant que le domaine est vérifié |
