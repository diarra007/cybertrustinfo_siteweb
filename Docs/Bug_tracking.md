...
| BUG-005 | 2025-01-23 | Erreur lors de l'envoi du formulaire de contact | En cours | P0 | - | Correction : le code simulait un succès même sans clé API. Maintenant retourne une erreur claire si RESEND_API_KEY est manquante. Problème actuel : variable configurée dans Vercel mais non accessible au runtime (nécessite redéploiement) |
